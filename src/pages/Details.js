    ...
    <section className="container mx-auto">
      <div className="flex flex-wrap my-4 md:my-12">
          ...
          <div className="slider">
            ...
            <div className="preview">
              <div className="item rounded-lg h-full overflow-hidden">
                <div className="item bg-gray-100 animate-pulse rounded-lg h-full overflow-hidden"></div>
              </div>
            </div>
          </div>
        </div>
        <div className="flex-1 px-4 md:p-6">
          ...
          <div className="w-72 h-4 mt-6 bg-gray-300 animate-pulse rounded-full"></div>
                ...
                >
                  <div className="rounded-xl p-4 pb-8 relative bg-white">
                    <div className="rounded-xl overflow-hidden card-shadow w-full h-36">
                      <div
                        className="bg-gray-100 animate-pulse rounded-lg h-full overflow-hidden"
